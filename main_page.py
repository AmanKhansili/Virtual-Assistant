...
def wish():
    ...
    if hour >= 0 and hour<12:
        speak("good morning sir i am virtual assistent calix")
    elif hour>=12 and hour<18:
        speak("good afternoon sir i am virtual assistent calix") 
    else:
        speak("good night sir i am virtual assistent calix")  
...
def command():
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            na_me = "Thanks for Asking my name my self ! calix"  
            print(na_me)
            speak(na_me)
